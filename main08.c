...
int main(int argc, char **argv)
{
	...
	{
		case 0:
			res = solve08(&f0, a, b, eps, &r);
			break;
		case 1:
			res = solve08(&f1, a, b, eps, &r);
			break;
		case 2:
			res = solve08(&f2, a, b, eps, &r);
			break;
		case 3:
			res = solve08(&f3, a, b, eps, &r);
			break;
		case 4:
			res = solve08(&f4, a, b, eps, &r);
			break;
		case 5:
			res = solve08(&f5, a, b, eps, &r);
			break;
		case 6:
			res = solve08(&f6, a, b, eps, &r);
	}
