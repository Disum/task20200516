...
int main(int argc, char **argv)
{
	...
	{
		case 0:
			res = solve10(&f0, a, eps, &r);
			break;
		case 1:
			res = solve10(&f1, a, eps, &r);
			break;
		case 2:
			res = solve10(&f2, a, eps, &r);
			break;
		case 3:
			res = solve10(&f3, a, eps, &r);
			break;
		case 4:
			res = solve10(&f4, a, eps, &r);
			break;
		case 5:
			res = solve10(&f5, a, eps, &r);
			break;
		case 6:
			res = solve10(&f6, a, eps, &r);
	}
